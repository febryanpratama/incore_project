...
<html dir="ltr" lang="en-US">
    <!-- Mirrored from canvastemplate.com/demo-seo-about.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2024 02:34:25 GMT -->
    <!-- Added by HTTrack -->
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('assets_template') }}/style.css" />

        <link rel="stylesheet" href="{{ asset('assets_template') }}/css/font-icons.css" />

        <link rel="stylesheet" href="{{ asset('assets_template') }}/css/components/bs-switches.css" />

        <link rel="stylesheet" href="{{ asset('assets_template') }}/demos/seo/seo.css" />

        <link rel="stylesheet" href="{{ asset('assets_template') }}/css/custom.css" />
    ...
    <body class="stretched">
                            ...
                            <div class="top-links">
                                <ul class="top-links-container">
                                    ...
                                    <li class="top-links-item">
                                        <a href="#"><img src="demos/seo/images/flags/eng.png" alt="Lang" />Eng</a>
                                        <ul class="top-links-sub-menu">
                                            <li class="top-links-item">
                                                <a href="#"><img src="demos/seo/images/flags/fre.png" alt="Lang" />French</a>
                                            </li>
                                            <li class="top-links-item">
                                                <a href="#"><img src="demos/seo/images/flags/ara.png" alt="Lang" />Arabic</a>
                                            </li>
                                            <li class="top-links-item">
                                                <a href="#"><img src="demos/seo/images/flags/tha.png" alt="Lang" />Thai</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                ...
                <div class="container position-relative">
                    <div class="page-title-row">
                        <div class="page-title-content">
                            ...
                            <h1>@foreach ($data->navigationvalue as $item)
                        ...
                        <div class="container mw-md">
                            ...
                            <div class="story-timeline">
                                ...
                                <div class="row justify-content-md-center">
                                    ...
                                    <div class="col-md-5">
                                        <h3 class="mb-3">
                                            <span class="counter counter-inherit text-dark"><span data-from="2" data-to="57" data-refresh-interval="10" data-speed="2000"></span>% Increase in Sales</span>
                                        </h3>
                                        Lorem ipsum, dolor sit amet consectetur, adipisicing elit. Corrupti quisquam molestiae consequuntur tempora recusandae impedit dolorum ex ipsum blanditiis similique?
                                    </div>
                                </div>
                                ...
                                <div class="row justify-content-md-center">
                                    ...
                                    <div class="col-md-5 text-md-end">
                                        <h3 class="mb-3">
                                            <span class="counter counter-inherit text-dark"><span data-from="20" data-to="410" data-refresh-interval="10" data-speed="2000"></span>+ Employees</span>
                                        </h3>
                                        Lorem ipsum, dolor sit amet consectetur, adipisicing elit. Corrupti quisquam molestiae consequuntur tempora recusandae impedit dolorum ex ipsum blanditiis similique?
                                    </div>
                                </div>
                    ...
                    <div class="section bg-transparent">
                        <div class="container">
                            <div class="row col-mb-30 align-content-stretch">
                                ...
                                {{-- Initialize PRoduct Foreach --}}
                                {{-- @foreach ($data->navigationvalue->card as $pd)
                                            ...
                                            <div class="card-body p-5">
                                                <div class="feature-box flex-column">
                                                    ...
                                                    <div class="fbox-content">
                                                        <h3 class="text-transform-none ls-0 text-larger">{{ $pd->title }}</h3>
                                                        <p class="text-smaller">{{ $pd->description }}</p>
                                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 d-flex">
                                        <a href="demo-seo-experience.html" class="card h-shadow h-translate-y-sm all-ts">
                                            <div class="card-body p-5">
                                                <div class="feature-box flex-column">
                                                    <div class="fbox-image mb-5 text-center">
                                                        <img height="150" src="{{ asset('file_card/'.$it->file) }}" alt="Feature Icon" />
                                                    </div>
                                                    <div class="fbox-content">
                                                        <h3 class="text-transform-none ls-0 text-larger">{{ $it->title }}</h3>
                                                        <p class="text-smaller">{{ $it->description }}</p>
                                                    </div>
                                                    {{-- <ul class="iconlist ms-3 mt-4 mb-0">
                                                        <li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> Unlimited Pages</li>
                                                        <li class="mb-2 text-muted"><i class="fa-solid fa-check text-smaller color"></i> UI/UX Design</li>
                                ...
                                {{-- End Initialize Product Foreach --}}
                            </div>
                        </div>
                    </div>
        ...
        <script src="{{ asset('assets_template') }}/js/chart.js"></script>
        <script src="{{ asset('assets_template') }}/js/chart-utils.js"></script>

        <script src="{{ asset('assets_template') }}/js/particles/particles.min.js"></script>
        <script src="{{ asset('assets_template') }}/js/particles/particles-line.js"></script>
        <script>
            // ============================================
    ...
    <!-- Mirrored from canvastemplate.com/demo-seo-about.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2024 02:34:26 GMT -->
</html>
