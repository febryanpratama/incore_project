...
<html dir="ltr" lang="en-US">
    <!-- Mirrored from canvastemplate.com/demo-seo-contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Mar 2024 02:34:25 GMT -->
    <!-- Added by HTTrack -->
                            ...
                            <div class="top-links">
                                <ul class="top-links-container">
                                    ...
                                    <li class="top-links-item">
                                        <a href="#"><img src="{{ asset('assets_template') }}/demos/seo/images/flags/eng.png" alt="Lang" />Eng</a>
                                        <ul class="top-links-sub-menu">
                                            <li class="top-links-item">
                                                <a href="#"><img src="{{ asset('assets_template') }}/demos/seo/images/flags/fre.png" alt="Lang" />French</a>
                                            </li>
                                            <li class="top-links-item">
            ...
            <section id="content">
                <div class="content-wrap pb-0">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-lg-3 col-md-6">
                                <div class="feature-box flex-column text-center">
                                    ...
                                    <div class="fbox-content">
                                        <h3 class="text-transform-none ls-0 mb-4">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="feature-box flex-column text-center">
                                    ...
                                    <div class="fbox-content">
                                        <h3 class="text-transform-none ls-0 mb-4">@foreach ($data->navigationvalue as $item)

                                            @if ($item->nama_section == '$value3')
                                                {{ $item->value }}
                                            @endif
                    ...
                    <section
                        ...
                        data-markers='[{address: "Melbourne, Australia", html: jQuery("#map-marker-1").html(), icon:{ image: "images/icons/map-icon-red.png", iconsize: [32, 39], iconanchor: [32,39] } }]'
                    ></section>
                    <div id="map-marker-1" class="d-none">
                        <div style="width: 300px;">
                            <h4 class="mb-2">Hi! We are <span>Envato!</span></h4>
                            <p class="mb-0" style="font-size: 1rem;">
                                Our mission is to help people to <strong>earn</strong> and to <strong>learn</strong> online. We operate <strong>marketplaces</strong> where hundreds of thousands of people buy and sell digital goods every
                                day.
                            </p>
                        </div>
                    </div>
                                    ...
                                    <div class="card shadow-sm">
                                        <div class="card-body">
                                            ...
                                            <div class="form-widget">
                                                ...
                                                <form class="row mb-0" id="template-contactform" name="template-contactform" action="https://canvastemplate.com/include/form.php" method="post">
