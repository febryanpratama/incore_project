                            ...
                            <form action="{{ route('konten.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="alert alert-danger">
                                        Posting Twitter masih dalam tahap pengembangan!
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="sosmed_type" id="sosmed-type" class="form-control">
...
<script>
    ...
    function callAccount(id) {
        $.ajax({
            url: `https://digimar.indonesiacore.com/api/accounts?app=${id}`,
            type: "GET",
            success: function(response) {
